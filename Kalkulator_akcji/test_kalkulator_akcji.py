...
data = {
    ...
    "Side": ["buy", "buy", "buy", "buy", "sell", "sell", "sell", "buy", "sell", "buy", "buy", "sell", "sell"],
    "Symbol ID": ["ABC123", "ABC123", "ABC123", "ABC123", "ABC123", "ABC123", "XYZ", "ZL123", "ZL123", "SETT", "SETT", "SETT", "SETT"],
    "ISIN": ["PL1234567890", "PL1234567890", "PL1234567890", "PL1234567890", "PL1234567890", "PL1234567890", "PL12345", "PUPA1", "PUPA1", "PUPA2", "PUPA2", "PUPA2", "PUPA2"],
    "Currency": ["PLN", "PLN", "PLN", "PLN", "PLN", "PLN", "USD", "PLN", "PLN", "PLN", "PLN", "PLN", "PLN"],
    "Quantity": [100, 50, 200, 50, 125, 265, 100, 50, 100, 10, 10, 10, 10],
    "Commission": [1.0, 1.0, 2.00, 1.0, 1.25, 2.65, 5.0, 1.0, 2.0, 1.0, 1.0, 1.0, 1.0],
    "Commission Currency": ["PLN", "PLN", "PLN", "PLN", "PLN", "PLN", "USD", "PLN", "PLN", "PLN", "PLN", "PLN", "PLN"],
    "Traded Volume": [10000, 4900, 18000, 4900, 12375, 37100, 1000, 10000, 20000, 1000, 1000, 1050, 1040],
}
